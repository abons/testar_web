...
set DEFAULT_JVM_OPTS="-Dlog4j.configurationFile=log4j2.xml" "-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005"
...
@rem Execute testar
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TESTAR_OPTS%  -classpath "%CLASSPATH%" org.fruit.monkey.Main %*
